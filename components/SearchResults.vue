    ...
    <div class="sticky top-0 z-30 bg-white/90 backdrop-blur border-b border-gray-100">
      <div class="max-w-6xl mx-auto px-3 md:px-6 py-3">
        <div class="flex items-center gap-2">
          ...
          <button v-if="false" @click="showProfile = true" class="shrink-0 w-10 h-10 grid place-items-center rounded-xl border border-gray-200 text-gray-500 hover:text-primary-600 hover:border-gray-300 transition" aria-label="Tu perfil de compras" title="Tu perfil de compras">
