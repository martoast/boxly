...
const GALLERY_TOOLS = new Set(['search_products', 'curate_products', 'browse_store', 'browse_stores', 'show_products', 'show_saved_products', 'find_live_product', 'show_orders'])
