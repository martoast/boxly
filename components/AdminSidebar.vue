...
const navItems = computed(() => [
  ...
  { route: '/app/admin/genders', icon: IdentificationIcon, label: t.value.storeGenders },
  { route: '/app/admin/store-hero', icon: PhotoIcon, label: t.value.storeHero },
  { route: '/app/admin/store-sales', icon: ChartBarIcon, label: t.value.storeSales },
