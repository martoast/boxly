    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-4">
      <div class="bg-gradient-to-br from-primary-600 to-primary-500 text-white rounded-3xl p-8 sm:p-10 text-center shadow-xl">
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
          <NuxtLink to="/register" class="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-white text-primary-700 font-bold rounded-full shadow-md hover:bg-gray-100 transition-colors">
            {{ t.ctaRegister }}
          </NuxtLink>
        </div>
      </div>
