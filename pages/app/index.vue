                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                      ...
                      <div class="flex flex-col gap-2">
                        <a
                          ...
                          class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-green-500 text-white text-sm font-semibold rounded-xl hover:bg-green-600 active:bg-green-700 transition-colors"
                        >
                        ...
                        <a
                          href="https://maps.google.com/?q=482+W+San+Ysidro+Blvd+San+Ysidro+CA+92173"
                          target="_blank"
                          rel="noopener noreferrer"
                          class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-xl border border-gray-300 hover:bg-gray-100 active:bg-gray-200 transition-colors"
                        >
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="space-y-4">
            ...
            <NuxtLink
              ...
              to="/app/affiliate/join"
              class="block relative overflow-hidden bg-gradient-to-br from-emerald-500 via-green-500 to-teal-600 rounded-2xl p-5 shadow-lg animate-fadeIn group hover:shadow-xl transition-all duration-300"
            ...
            >
              ...
              <div class="relative">
                ...
                <!-- CTA Button -->
                <div
                  class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-green-600 font-semibold rounded-xl group-hover:bg-green-50 transition-all duration-300 group-hover:scale-[1.02]"
                >
                  {{ t.startEarning }}
...
const translations = {
  ...
  dropOffAppointmentRequired: {
    es: "⚠️ Debes agendar una cita antes de presentarte. No se aceptan entregas sin cita previa.",
    en: "⚠️ You must schedule an appointment before dropping off. Walk-ins are not accepted.",
  },
  dropOffScheduleWhatsApp: {
    es: "Agendar cita por WhatsApp",
    en: "Schedule via WhatsApp",
  },
  dropOffViewOnMaps: {
