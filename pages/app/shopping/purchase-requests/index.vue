    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      >
        ...
        <AdminPurchaseRequestMobileList
          ...
          :requests="requests"
          base-path="/app/shopping/purchase-requests"
          class="md:hidden"
        />
          ...
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-100">
              <tr
                ...
                @click="navigateTo(`/app/shopping/purchase-requests/${req.id}`)"
              >
...
const fetchRequests = async (page = 1) => {
  loading.value = true;
  try {
    const { data } = await $customFetch("/shopping/purchase-requests", {
      params: {
        page,
...
const bulkDelete = async () => {
  ...
  try {
    await $customFetch("/shopping/purchase-requests/bulk", {
      method: "DELETE",
...
const mergeRequests = async () => {
  ...
  try {
    const response = await $customFetch("/shopping/purchase-requests/merge", {
      method: "POST",
