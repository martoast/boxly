        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="c in categories" :key="c.id" class="hover:bg-gray-50">
              ...
              <td class="hidden sm:table-cell px-4 py-3 text-gray-500 font-mono text-xs">{{ c.slug }}</td>
              <td class="px-4 py-3">
              ...
              <td class="px-4 py-3 text-right">
                <NuxtLink :to="`${editBasePath}/${c.id}/edit`" class="inline-flex items-center justify-center -my-1 px-3 py-2 rounded-lg text-primary-600 font-medium hover:bg-primary-50 text-sm">Editar</NuxtLink>
              </td>
            </tr>
          </tbody>
        </table>
