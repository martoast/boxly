            ...
            <div class="flex gap-3 items-start">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center gap-3 pt-2 border-t border-gray-100">
                  <NuxtLink :to="`/app/admin/products/${p.id}/edit`" class="text-primary-600 font-medium text-sm">Editar</NuxtLink>
...
const bulkGender = async () => {
  ...
  try {
    const res = await $customFetch('/admin/products/bulk-gender', {
      method: 'POST',
      body: {
        ids: selectedIds.value,
