    ...
    <div class="bg-white border-b border-gray-200">
      <div class="max-w-3xl mx-auto px-4 py-6 sm:py-8">
        <div class="flex items-start gap-3">
          ...
          <div
            v-if="hasItems"
            class="bg-primary-100 text-primary-700 px-3 py-1 rounded-full text-sm font-semibold flex-shrink-0"
          >
            {{ totalItems }} {{ t.items }}
          </div>
        </div>
...
const translations = {
  heroHeadline: { es: '¿No encuentras lo que buscas? Pídelo.', en: "Can't find what you need? Request it." },
  heroSubheadline: {
    es: 'Te lo conseguimos de cualquier tienda de USA y te lo enviamos a México.',
    en: "We'll grab it from any US store and ship it to Mexico.",
  },
  backToShop: { es: 'Volver a la tienda', en: 'Back to shop' },
  removeItem: { es: 'Eliminar artículo', en: 'Remove item' },
