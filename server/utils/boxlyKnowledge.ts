...
1. **Compra asistida (Boxly compra por ti):** para clientes que no tienen una tarjeta aceptada en tiendas de EE. UU. Boxly compra el producto por ti. Pagas: precio del producto + **10% de comisión de Boxly** + precio de la caja (envío) + impuestos cuando aplican (IVA 16% sobre el valor declarado de $50 USD o más). El 10% SOLO aplica en este caso.
