...
La comisión de 15% NO se cobra siempre — depende de quién compra los productos:

1. **Compra asistida (Boxly compra por ti):** para clientes que no tienen una tarjeta aceptada en tiendas de EE. UU. Boxly compra el producto por ti. Pagas: precio del producto + **15% de comisión de Boxly** + precio de la caja (envío) + impuestos cuando aplican (IVA 16% sobre el valor declarado de $50 USD o más). **El 15% se calcula sobre el TOTAL FINAL de la compra al hacer checkout (producto + el envío que cobre la tienda hasta nuestra bodega en San Diego + impuestos que cobre la tienda), NO solo sobre el precio de lista que se muestra.** El 15% SOLO aplica en este caso.

2. **Casillero / envío propio (tú compras, Boxly solo envía):** si compras tus propios productos con tu tarjeta y los mandas a tu dirección Boxly en EE. UU., Boxly solo los consolida y los envía. Pagas **solo el precio de la caja (envío fijo)** — SIN comisión del 15%.
